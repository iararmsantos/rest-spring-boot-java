...
import com.iarasantos.security.jwt.JwtConfigurer;
import com.iarasantos.security.jwt.JwtTokenProvider;
...
public class SecurityConfig {
    ...
    //old method configure when we were able to use WebSecurityConfigurerAdapter
    @Bean
